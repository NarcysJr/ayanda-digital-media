    ...
    this.innerHTML = `
      <header class="fixed w-full bg-black text-white shadow-lg z-50">
        <div class="container mx-auto flex justify-between items-center p-4">
          ...
          <!-- Logo -->
          <a href="/ayanda-digital-media/index.html" id="logoAyanda" 
          ...
          <nav id="menu" 
            ...
            <a href="/ayanda-digital-media/index.html" class="menu-link">Início</a>

            <!-- Dropdown Sobre -->
            <div class="relative group dropdown-container">
              <a href="/ayanda-digital-media/sobre.html" 
              ...
              <div class="submenu absolute left-0 top-full w-44 bg-black border border-[#D4AF37]/30 rounded-lg 
                ...
                <a href="/ayanda-digital-media/sobre.html#missao" class="block px-4 py-2 hover:bg-[#D4AF37]/10">Missão</a>
                <a href="/ayanda-digital-media/sobre.html#visao" class="block px-4 py-2 hover:bg-[#D4AF37]/10">Visão</a>
                <a href="/ayanda-digital-media/sobre.html#valores" class="block px-4 py-2 hover:bg-[#D4AF37]/10">Valores</a>
              </div>
            </div>

            <a href="/ayanda-digital-media/servicos.html" class="menu-link">Serviços</a>
            <a href="/ayanda-digital-media/contactos.html" class="menu-link">Contactos</a>
          </nav>
        </div>
      </header>
    `;
